...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder='Hours Worked' onChangeText={newText => setHoursWorked(newText)}/>
      <Text>Please enter your hourly rate:</Text>
      <TextInput placeholder='Hourly Rate' onChangeText={newText => setHourlyRate(newText)}/>
      ...
      */}
      <Button title='Calculate Pay' onPress={() => {console.log('Salary R' + parseInt(hoursWorked)*parseInt(hourlyRate))}}/>
